...
import type { Payout, NotificationType } from '../../types.ts';

import { functions } from '../../services/firebase.ts';
import { X, Check, Loader, Send } from 'lucide-react';
...
const PayoutModal: React.FC<PayoutModalProps> = ({ payout, onClose, showNotification }) => {
    ...
    const handleProcessPayout = async () => {
        setIsLoading(true);
        try {
            const processPayoutFunction = functions.httpsCallable('processAffiliatePayout');
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
                <header className="p-6 border-b flex justify-between items-center">
                     <h3 className="text-xl font-bold text-gray-800">Process Payout</h3>
                ...
                <main className="p-6 space-y-4">
                    <div>
                     ...
                     <div>
                        ...
                        <p className="whitespace-pre-wrap bg-gray-100 p-2 rounded-md">{payout.details}</p>
                    </div>
                     <div>
