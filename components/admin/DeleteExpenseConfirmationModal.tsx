...
import type { Expense, NotificationType } from '../../types.ts';
...
const DeleteExpenseConfirmationModal: React.FC<DeleteExpenseConfirmationModalProps> = ({ expense, onClose, showNotification }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-[80] p-4">
            <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm text-center">
                ...
                <div className="mt-2 text-sm text-gray-500">
                    ...
                    <p className="font-semibold mt-2">{expense.description}</p>
