...
interface DeleteBlogConfirmationModalProps {
    post: BlogPost | null;
    onClose: () => void;
    onConfirm: () => Promise<void>;
}

const DeleteBlogConfirmationModal: React.FC<DeleteBlogConfirmationModalProps> = ({ post, onClose, onConfirm }) => {
    if (!post) return null;
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mt-4">Delete Blog Post</h3>
                <div className="mt-2 text-sm text-gray-500">
                    <p>Are you sure you want to delete the post <strong className="font-bold">"{post.title}"</strong>?</p>
