...
interface DeleteBulkWebinarPurchaseConfirmationModalProps {
    count: number;
    isOpen: boolean;
    onClose: () => void;
...
const DeleteBulkWebinarPurchaseConfirmationModal: React.FC<DeleteBulkWebinarPurchaseConfirmationModalProps> = ({ count, isOpen, onClose, onConfirm }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-[70] p-4">
            <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mt-4">Delete Webinar Purchases</h3>
                <div className="mt-2 text-sm text-gray-500">
                    <p>Are you sure you want to delete <strong className="font-bold">{count}</strong> selected purchase record(s)?</p>
...
export default DeleteBulkWebinarPurchaseConfirmationModal;
